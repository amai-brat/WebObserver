...
namespace WebObserver.Main.Infrastructure.Migrations
{
    ...
    [Migration("20250523105354_AddPayloadSummary")]
    partial class AddPayloadSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.Text.TextPayload, WebObserver.Main.Domain.Text.TextDiffPayload>", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ObservingEntry<TextPayload, TextDiffPayload>");
                });

            modelBuilder.Entity("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistPayload, WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiffPayload>", b =>
                {
                    b.HasBaseType("WebObserver.Main.Domain.Base.ObservingEntryBase");
                    ...
                    b.HasDiscriminator().HasValue("ObservingEntry<YouTubePlaylistPayload, YouTubePlaylistDiffPayload>");
                });
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Text.TextObservingEntry", b =>
                {
                    b.HasBaseType("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.Text.TextPayload, WebObserver.Main.Domain.Text.TextDiffPayload>");
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistObservingEntry", b =>
                {
                    b.HasBaseType("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistPayload, WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiffPayload>");
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Base.DiffBase", b =>
                {
                    b.HasOne("WebObserver.Main.Domain.Base.ObservingEntryBase", "FirstEntry")
                        .WithMany()
                        .HasForeignKey("FirstEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebObserver.Main.Domain.Base.ObservingEntryBase", "SecondEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.Text.TextPayload, WebObserver.Main.Domain.Text.TextDiffPayload>", b =>
                {
                    ...
                    b.HasOne("WebObserver.Main.Domain.Base.Diff<WebObserver.Main.Domain.Text.TextDiffPayload>", "LastDiff")
                        .WithMany()
                        .HasForeignKey("LastDiffFirstEntryId", "LastDiffSecondEntryId")
                        .HasConstraintName("fk_observing_entries_diff_text_diff_payload_last_diff_first_en");
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistPayload, WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiffPayload>", b =>
                {
                    ...
                    b.HasOne("WebObserver.Main.Domain.Base.Diff<WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiffPayload>", "LastDiff")
                        .WithMany()
                        .HasForeignKey("LastDiffFirstEntryId", "LastDiffSecondEntryId")
                        .HasConstraintName("fk_observing_entries_diff_you_tube_playlist_diff_payload_last_");
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Text.TextPayload", b =>
                {
                    b.HasOne("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.Text.TextPayload, WebObserver.Main.Domain.Text.TextDiffPayload>", null)
                        .WithOne("Payload")
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistPayload", b =>
                {
                    b.HasOne("WebObserver.Main.Domain.Base.ObservingEntry<WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistPayload, WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiffPayload>", null)
                        .WithOne("Payload")
