...
namespace WebObserver.Main.Infrastructure.Migrations
{
    ...
    [Migration("20250525160832_EnrichYouTubePlaylist")]
    partial class EnrichYouTubePlaylist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_you_tube_playlist_items");

                    b.ToTable("you_tube_playlist_items", (string)null);
                });
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Text.TextDiff", b =>
                {
                    b.HasBaseType("WebObserver.Main.Domain.Base.DiffBase");

                    b.ToTable("text_diff", (string)null);
                });

            modelBuilder.Entity("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistDiff", b =>
                {
                    b.HasBaseType("WebObserver.Main.Domain.Base.DiffBase");

                    b.ToTable("you_tube_playlist_diff", (string)null);
                });
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.Base.ObservingEntryBase", b =>
                {
                    b.HasOne("WebObserver.Main.Domain.Base.ObservingBase", null)
                        .WithMany("Entries")
                    ...
                    b.HasOne("WebObserver.Main.Domain.Base.DiffBase", "LastDiff")
                        ...
                        .HasConstraintName("fk_observing_entries_diff_base_last_diff_first_entry_id_last_d");
            ...
            modelBuilder.Entity("WebObserver.Main.Domain.YouTubePlaylist.UnavailableYouTubePlaylistItem", b =>
                {
                    b.HasOne("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistItem", "CurrentItem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_unavailable_you_tube_playlist_item_you_tube_playlist_items_");

                    b.HasOne("WebObserver.Main.Domain.YouTubePlaylist.YouTubePlaylistItem", "SavedItem")
                        .WithMany()
                        .HasForeignKey("SavedItemId")
                        .HasConstraintName("fk_unavailable_you_tube_playlist_item_you_tube_playlist_items_1");
